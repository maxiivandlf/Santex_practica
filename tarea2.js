  ...
  async agregarProducto(sku, cantidad) {
    ...
    if (producto) {
      ...
      if (productoEnCarrito) {
        ...
        // Si el producto no está en el carrito, lo agrego como nuevo
    ...
    return new Promise((resolve, reject) => {
      ...
      if (productoEnCarrito) {
        if (cantidad < productoEnCarrito.cantidad) {
          // Si la cantidad es menor a la cantidad del producto en el carrito, restar la cantidad
          productoEnCarrito.cantidad -= cantidad;
        } else {
          // Si la cantidad es mayor o igual, eliminar el producto del carrito
